...
import { User, LogIn, UserPlus, LogOut, Settings, Trophy, BarChart3, Menu, X, Tv, BookOpen, Newspaper, Users, Clock, Globe } from "lucide-react";
...
export default function Header() {
  ...
  const navItems = [
    ...
    { href: "/descobrir", label: "Descobrir", icon: Globe },
